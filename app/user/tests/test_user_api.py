...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@django123.com', 'password': 'Testpass123'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@django123.com', password='Testpass123')
        payload = {'email': 'test@django123.com', 'password': 'Wrongpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        create_user(email='test@django123.com', password='Testpass123')
        payload = {'email': 'test@django123.com'}
        res = self.client.post(TOKEN_URL, payload)
